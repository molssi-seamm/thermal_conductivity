...
do
	...
	sphinx-apidoc -o docs/developer thermal_conductivity_step
...
<html>
   <head>
      <title>Documentation for the Thermal Conductivity plug-in for SEAMM</title>
   </head>
   <body>
      <h1>Documentation for the Thermal Conductivity plug-in for SEAMM</h1>
      <h2>Branches</h2>
      <ul>
EOF
