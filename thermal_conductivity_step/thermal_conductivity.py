...
class ThermalConductivity(seamm.Node):
    ...
    def __init__(
        ...
        namespace="org.molssi.seamm.thermal_conductivity",
        extension=None,
        logger=logger
    ):
    ...
    def description_text(self, P=None):
        ...
        while node is not None:
            try:
                ...
                print(
                    "Unexpected error describing thermal_conductivity flowchart: {} in {}"
    ...
    def run(self):
        ...
        result = local.run(
            cmd=["Thermal Conductivity", "-in", "molssi.dat"],
            files=files,
            return_files=[]
        )  # yapf: disable

        if result is None:
            logger.error("There was an error running Thermal Conductivity")
            return None
